...
<div class="page-wrapper">
            ...
            <div class="mixitup-gallery">
                ...
                <div class="filters clearfix">
                	...
                	<ul class="filter-tabs filter-btns text-center clearfix">
                        ...
                        <li class="filter" data-role="button" data-filter=".residential-interior">Drift</li>
                        <li class="filter" data-role="button" data-filter=".interior">Course de voiture</li>
                        <li class="filter" data-role="button" data-filter=".kitchen">Course motos</li>
                        <li class="filter" data-role="button" data-filter=".wardrobe">Cyclisme</li>
							...
							<figure class="image-box">
								...
								<div class="overlay-box">
									<div class="overlay-inner">
										<div class="content">
											<h3><a href="projects-fullwidth.html">Drift</a></h3>
											<a href="images/gallery/111.jpg" data-fancybox="gallery-4" data-caption="" class="link"><span class="icon flaticon-magnifying-glass-1"></span></a>
						...
						<div class="inner-box">
							<figure class="image-box">
								...
								<div class="overlay-box">
									<div class="overlay-inner">
										<div class="content">
											<h3><a href="projects-fullwidth.html">Course de voituren</a></h3>
											<a href="images/gallery/333.jpg" data-fancybox="gallery-4" data-caption="" class="link"><span class="icon flaticon-magnifying-glass-1"></span></a>
											<a href="projects-fullwidth.html" class="link"><span class="icon flaticon-unlink"></span></a>
										</div>
									</div>
								</div>
						...
						<div class="inner-box">
							<figure class="image-box">
								...
								<div class="overlay-box">
									<div class="overlay-inner">
										<div class="content">
											<h3><a href="projects-fullwidth.html">Course motos</a></h3>
											<a href="images/gallery/222.jpg" data-fancybox="gallery-4" data-caption="" class="link"><span class="icon flaticon-magnifying-glass-1"></span></a>
											<a href="projects-fullwidth.html" class="link"><span class="icon flaticon-unlink"></span></a>
										</div>
									</div>
								</div>
						...
						<div class="inner-box">
							<figure class="image-box">
								...
								<div class="overlay-box">
									<div class="overlay-inner">
										<div class="content">
											<h3><a href="projects-fullwidth.html">Cyclisme</a></h3>
											<a href="images/gallery/444.jpg" data-fancybox="gallery-4" data-caption="" class="link"><span class="icon flaticon-magnifying-glass-1"></span></a>
											<a href="projects-fullwidth.html" class="link"><span class="icon flaticon-unlink"></span></a>
										</div>
									</div>
								</div>
	...
	<section class="evenement">
						<div class="container">
							...
							<a href="afficherListeevenement1.php">
  <button>tri</button>

  <br> <a href="projects-classic.php">la liste des evenements</a> </br>
	...
	<body>
		...
		<table border="1" align="center">
			...
			<tr>
				...
				<td><img src=<?php echo $evenement['imagee'];  ?> alt= <?php echo $evenement['nom_e'];  ?> /></td>
				<td>
		...
		<div class="container">
			<div class="row">
				...
				<iframe width="560" height="315" src="https://www.youtube.com/embed/oFZ43_ln8tg" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
				</div>
				</div>
				</div>
				</section>
