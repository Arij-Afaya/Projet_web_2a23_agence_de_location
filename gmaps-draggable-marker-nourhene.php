                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                           ...
                           <!-- <li class="menu-sub-header">Charts</li> -->
                            <li><a class="nav-link" href="modules-chartjs-nourhene.php">Supprimer Evenements</a></li>
            ...
            <section class="section">
                <div class="section-header">
                    ...
                    <div class="section-header-breadcrumb">
                        ...
                        <div class="breadcrumb-item">Modifier les sponsors</div>
                    </div>
                </div>

                <div class="section-body">
                    <h2 class="section-title">Les Sponsors</h2>
                    <p class="section-lead">Modifier ici les sponsors.</p> 
                    <div class="row">
                        <div class="col-12 col-sm-6 col-md-6 col-lg-3">
                            <article class="article">
                                <div class="article-header">
                                    <div class="article-image" data-background="assets/img/news/m1.png">
                                    </div>
...
<?php
    ...
    include_once '../controlleur/sponsorsC.php';
    ...
    if (
        isset($_POST["id_s"]) &&
		isset($_POST["nom_s"]) &&		
        isset($_POST["date_contrat"]) &&
        isset($_POST["prix_contrat"]) &&
        isset($_POST["imagee1"])
        ...
        if (
            !empty($_POST["id_s"]) && 
			!empty($_POST['nom_s']) &&
            !empty($_POST["date_contrat"]) && 
            !empty($_POST["prix_contrat"]) && 
            !empty($_POST["imagee1"]) 
            ...
            $sponsorsC->modifiers($sponsors, $_POST["id_s"]);
            header('Location:projects-fullwidth.php');
        }
        else
...
<head>
    ...
    <body>
        <button><a href="projects-fullwidth.php">Retour à la liste des sponsors</a></button>
        <hr>
		...
		<?php
			if (isset($_POST['id_s'])){
				$sponsors = $sponsorsC->recuperersponsors($_POST['id_s']);
        ...
        <form action="" method="POST">
            <table border="1" align="center">
                <tr>
                    <td>
                        <label for="id_s">l'id du sponsors:
                        </label>
                    </td>
                    <td><input type="text" name="id_s" id="id_s" value="<?php echo $sponsors['id_s']; ?>" maxlength="20"></td>
                </tr>
				<tr>
                    <td>
                        <label for="nom_s">Nom du sponsors:
                        </label>
                    </td>
                    <td><input type="text" name="nom_s" id="nom_s" value="<?php echo $sponsors['nom_s']; ?>" maxlength="20"></td>
                </tr>
                <tr>
                    <td>
                        <label for="date_contrat">date du contart:
                        </label>
                    </td>
                    <td><input type="date" name="date_contrat" id="date_contrat" value="<?php echo $sponsors['date_contrat']; ?>" maxlength="20"></td>
                </tr>
               
                <tr>
                    <td>
                        <label for="prix_contrat">prix:
                        </label>
                    </td>
                    <td>
                        <input type="number" name="prix_contrat" id="prix_contrat" value="<?php echo $sponsors['prix_contrat']; ?>">
                    </td>
                </tr>

                <tr>
                    <td>
                        <label for="imagee1">image:
                        </label>
                    </td>
                    <td>
                        <input type="text" name="imagee1" id="imagee1" value="<?php echo $sponsors['imagee1']; ?>">
                    </td>
                </tr>
