...
<title>Gestion des Utulisateurs &rsaquo;  &mdash; Localuxe</title>
...
<div id="app">
        ...
        <nav class="navbar navbar-expand-lg main-navbar">
            ...
            <ul class="navbar-nav navbar-right">
                ...
                <li class="dropdown">
                    ...
                    <div class="d-sm-none d-lg-inline-block">Salut, Sedraoui Samar </div></a>
        ...
        <div class="main-sidebar sidebar-style-2">
            <aside id="sidebar-wrapper">
                <div class="sidebar-brand">
                    <a href="index-2.html">Gestion Des Utulisateurs</a>
                </div>
                ...
                <ul class="sidebar-menu">
                   <!-- <li class="menu-header">Dashboard</li>
                    ...
                    <li class="dropdown active">
                        ...
                        <ul class="dropdown-menu">
                            <li class="active"><a class="nav-link" href="ajoutreservationback.php">Ajouter Un Utulisateur</a></li>
                            <li class="active"><a class="nav-link" href="components-avatar.php">Ajouter Une Reservation</a></li>
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li><a class="nav-link" href="affichagereservationback.php">Afficher Les Utulisateurs</a></li>
                            <li><a class="nav-link" href="forms-editor.php">Afficher Les Reservations</a></li>
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li><a href="modifierreservationback.php">Modifier Les Utulisateurs</a></li>
                            <li><a href="gmaps-draggable-marker.php">Modifier Les Reservations</a></li>
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                           ...
                           <!-- <li class="menu-sub-header">Charts</li> -->
                            <li><a class="nav-link" href="supprimerreservationback.php">Supprimer Les Utulisateurs</a></li>
                            <li><a class="nav-link" href="modules-apex-charts.php">Supprimer Les Reservations</a></li>
            ...
            <section class="section">
                <div class="section-header">
                    ...
                    <div class="section-header-breadcrumb">
                        <div class="breadcrumb-item active"><a href="#">Ajout</a></div>
                        <div class="breadcrumb-item"><a href="#">Localuxe</a></div>
                        <div class="breadcrumb-item">Utulisateur</div>
                    </div>
                </div>

                <div class="section-body">
                    <h2 class="section-title">Les reservations</h2>
                    <p class="section-lead">la liste des reservations.</p>

                    <div class="row">
                        <div class="col-12 col-sm-6 col-md-6 col-lg-3">
                            <article class="article">
                                <div class="article-header">
                                    <div class="article-image" data-background="assets/img/news/123.jpg">
                                    </div>
                                    <!--
                            ...
                            <article class="article article-style-c">
                                ...
                                <div class="article-details">
                                    ...
                                    <div class="article-user">
                                        <img alt="image" src="assets/img/avatar/q1.jpg">
    ...
    if(isset($_POST['tri'])){
        $listeReservations = $reservationC->trireservation();
    }
    
    else if (isset($_GET['id_r'])){
        $listeReservations = $reservationC->recherchereservation($_GET['id_r']); 
    }else {
                $listeReservations = $reservationC->afficherreservations();
            }
...
<html>
    ...
    <form action="" method="GET" 
                        ...
                        <div class="input-group">
                         ...
                         <!--  name lazem aalkhtr najmooo nrecupiro byh l valeur -->
                            <input type="text" name="id_r" class="form-control bg-light border-0 small" placeholder="Search for..."
    ...
    <button><a href="ajoutreservationback.php">Ajouter une  reservation</a></button>
           <button><a href="searchreservation.php">jointure</a></button>
                       <div>
		 ...
		 <table border="1" align="center">
			 <tr>
				<!--<th>Id_r</th>-->
				<th>Date de  debut de réservation</th>
			...
			<tr>
				...
				<td><?php echo  $reservation['date_db']; ?></td>
				<td><?php echo  $reservation['date_df']; ?></td>
				<td><?php echo  $reservation['num_permis']; ?></td>
                
               

				<td>
					<form method="POST" action="modifierreservationback.php">
						<input type="submit" name="Modifier" value="Modifier">
						<input type="hidden" value=<?PHP echo $reservation['id_r']; ?> name="id_r">
					</form>
				</td>
				<td>
					<a href="supprimerreservationback.php?id_r=<?php echo $reservation['id_r']; ?>">Supprimer</a>
				</td>
			</tr>
			<?php
				}
