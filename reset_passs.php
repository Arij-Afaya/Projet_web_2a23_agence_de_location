...
if(isset($_POST["submit_email"])){
    ...
    $message="http://http://localhost/login/views/changepwd.php";
...
<!--<link rel="stylesheet" href="reset.css" media="screen">-->
  ...
  <body class="u-body">
    ...
    <section class="u-align-center u-clearfix u-palette-1-base u-section-1" id="carousel_3906">
      <div class="u-clearfix u-sheet u-valign-middle-sm u-valign-middle-xs u-sheet-1">
        <div class="u-border-20 u-border-custom-color-1 u-image u-image-circle u-image-1" data-image-width="736" data-image-height="1092"></div>
 ...
 <script type="text/javascript" src="//translate.google.com/translate_a/element.js?cb=googleTranslateElementInit"></script>
        ...
        <h6 class="u-text u-text-2"> Nous comprenons, il se passe des choses. Entrez simplement votre adresse e-mail ci-dessous et nous vous enverrons un lien pour réinitialiser votre mot de passe !<br>
          <br>
          <br>
          <br>
          <br>
        ...
        <div class="u-form u-form-1">
            ...
            <form class="register-form" method="POST" >
                ...
                <div class="u-form-email u-form-group">
                    <input type="email" class="u-border-1 u-border-grey-30 u-input u-input-rectangle u-radius-13 u-white u-input-1" required="" name="email"   placeholder="Entrez votre adresse email">
               
                  </div>
                
                <div class="u-align-left u-form-group u-form-submit">
                
                <input type="submit" name="submit_email" class="u-btn u-btn-round u-btn-submit u-button-style u-radius-10">
