                                ...
                                <ul class="navigation clearfix">
                                    ...
                                    <li class="dropdown"><a href="services-dark.html">Véhicules</a>
                                        <ul>
                                            ...
                                            <li><a href="affichagedisponibilite.php">Véhicules exclusivement disponibles</a></li>
                                        </ul>
                                    </li>
...
<script>
  function fileValidation() {
    ...
    <!--<form action="" method="POST"> hedha l asli-->
    <form name="clubForm"  method="post">
        ...
        <!--<form name="clubForm" onsubmit="return validateForm(event)" method="post">-->
            ...
            <tr>
                ...
                <td><input type="text" name="image" id="image" width="1000" height="500" onchange="return fileValidation()"></td>
            </tr>
