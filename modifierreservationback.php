...
<title>Gestion des Reservations &rsaquo; &mdash; Localuxe</title>
...
<div id="app">
        ...
        <div class="main-sidebar sidebar-style-2">
            <aside id="sidebar-wrapper">
                ...
                <ul class="sidebar-menu">
                    ...
                    <li class="menu-header">Gestion Reservation</li>
                    <li class="dropdown">
                        <a href="#" class="nav-link has-dropdown"><i class="fas fa-th-large"></i> <span>ajout</span></a>
                        <ul class="dropdown-menu">
                            <li><a class="nav-link" href="components-article.php">ajout utulisateur</a></li>
                            <li><a class="nav-link beep beep-sidebar" href="ajoutreservationback.php">ajout reservation</a></li>
                        </ul>
                    </li>
                    <li class="dropdown active">
                        <a href="#" class="nav-link has-dropdown"><i class="far fa-file-alt"></i> <span>Affichage</span></a>
                        <ul class="dropdown-menu">
                            <li class="active"><a class="nav-link" href="affichageuserback.php">affichage toute liste des utulisateurs</a></li>
                            <li><a class="nav-link" href="affichagereservationback.php">afficher Reservation</a></li>
                        </ul>
                    </li>
                    <li class="dropdown">
                        <a href="#" class="nav-link has-dropdown"><i class="fas fa-map-marker-alt"></i> <span>Modification</span></a>
                        <ul class="dropdown-menu">
                            <li><a href="gmaps-advanced-route.html">Modification utulisateur</a></li>
                            <li><a href="gmaps-draggable-marker.html">Modification reservation</a></li>
            ...
            <section class="section">
                <div class="section-header">
                    ...
                    <div class="section-header-breadcrumb">
                        <div class="breadcrumb-item active"><a href="#">Localuxe</a></div>
                        <div class="breadcrumb-item"><a href="#">Reservation</a></div>
                        <div class="breadcrumb-item">Affichage</div>
                    </div>
                </div>
    ...
    if (
        ...
        if (
            ...
            $reservationC->modifierreservation($reservation, $_POST["id_r"]);
...
<head>
    ...
    <!--<div class="foto">
        ...
        <button><a href="affichagereservationback.php">Retour à la liste des reservations</a></button>


        <button><a href="pagedisponibilite.php">reservation</a></button>
        <hr>
		...
		<?php
			if (isset($_POST['id_r'])){
				$reservation = $reservationC->recupererreservation($_POST['id_r']);
        ...
        <form action="" method="POST">
            <table border="1" align="center">
                <tr>
                    <td>
                        <label for="id_r">id reservation:
                        </label>
                    </td>
                    <td><input type="text" name="id_r" id="id_r" value="<?php echo $reservation['id_r']; ?>" maxlength="20"></td>
                </tr>
				
                <tr>
                    <td>
                        <label for="date_db">date db:
                        </label>
                    </td>
                    <td><input type="date" name="date_db" id="date_db" value="<?php echo $reservation['date_db']; ?>" maxlength="20"></td>
                </tr>
                
                <tr>
                    <td>
                        <label for="date_df">date df:
                        </label>
                    </td>
                    <td><input type="date" name="date_df" id="date_df" value="<?php echo $reservation['date_df']; ?>" maxlength="20"></td>
                </tr>

                <tr>
                    <td>
                        <label for="num_permis">Licence Number:
                        </label>
                    </td>
                    <td><input type="number" name="num_permis" id="num_permis" value="<?php echo $reservation['num_permis']; ?>" maxlength="20"></td>
                </tr>
