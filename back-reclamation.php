    ...
    <div class="main-wrapper main-wrapper-1">
        ...
        <nav class="navbar navbar-expand-lg main-navbar">
           ...
           <form action="" method="GET" 
                ...
                <li class="dropdown">
                    ...
                    <div class="d-sm-none d-lg-inline-block">Wajdi Ben Romdhane</div></a>
        ...
        <div class="main-content">
            <section class="section">
                ...
                <?php
	include '../wajdi/Controller/reclamationc.php';
	$reclamationC=new reclamationC();
  
     if (isset($_GET['id'])){
        $listereclamations = $reclamationC->recherchereclamation($_GET['id']); 
    }else {
