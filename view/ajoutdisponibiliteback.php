                ...
                <ul class="sidebar-menu">
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li><a class="nav-link beep beep-sidebar" href="components-avatar.html">ajout disponibilité</a></li>
                        </ul>
                    </li>
...
<head>
    ...
    <div class="logo">
        ...
        <button><a href="affichagedisponibiliteback.php">Retour à la liste des exclusivites disponibles</a></button>
