                   ...
                   <!-- <li class="menu-header">Dashboard</li>
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li><a class="nav-link" href="forms-editor.php">Afficher Les disponibilités</a></li>
            ...
            <section class="section">
                <div class="section-header">
                    ...
                    <div class="section-header-breadcrumb">
                        ...
                        <div class="breadcrumb-item">Véhicules</div>
                    </div>
                </div>

                <div class="section-body">
                    <h2 class="section-title">Les véhicules</h2>
                    <p class="section-lead">l'ajout d'un véhicule.</p>
