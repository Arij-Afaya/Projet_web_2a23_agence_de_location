            ...
            <aside id="sidebar-wrapper">
                ...
                <ul class="sidebar-menu">
                    ...
                    <li class="dropdown active">
                        ...
                        <ul class="dropdown-menu">
                            <li class="active"><a class="nav-link" href="forms-advanced-form.html">affichage toute liste véhicules</a></li>
                            <li><a class="nav-link" href="forms-editor.html">afficher disponibilité</a></li>
                        </ul>
                    </li>
                    <li class="dropdown">
            ...
            <section class="section">
                <div class="section-header">
                    ...
                    <div class="section-header-breadcrumb">
                        ...
                        <div class="breadcrumb-item"><a href="#">Véhicule</a></div>
...
<html>
	...
	<body>
	    ...
	    <button><a href="ajoutdisponibiliteback.php">Ajouter une disponibilite</a></button>
		...
		<table border="1" align="center">
			...
			<td><?php echo $disponibilite['idd']; ?></td>
				...
				<td>
					<form method="POST" action="modifierdiponibiliteback.php">
						<input type="submit" name="Modifier" value="Modifier">
						<input type="hidden" value=<?PHP echo $disponibilite['idd']; ?> name="idd">
					</form>
				</td>
				<td>
					<a href="supprimerdisponibiliteback.php?idd=<?php echo $disponibilite['idd']; ?>">Supprimer</a>
				</td>
			</tr>
			<?php
				}
