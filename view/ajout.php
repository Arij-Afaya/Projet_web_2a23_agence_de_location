    ...
    <!--<script>
            ...
            myform.addEventListener('submit', function(e)){
                ...
                if(myinput.value.trim() == ""){
                    let myerror=document.getElementById('errorr');
                    myerror.innerHTML="le champs marque est requis";
                    myerror.style.color='red';
                    e.preventDefault();
                } else if(myregx.test(myinput.value)==false){
                    let myerror=document.getElementById('errorr');
                    myerror.innerHTML="le champs marque doit contenir";
                    myerror.style.color='red';
                    e.preventDefault();
                }
            }
