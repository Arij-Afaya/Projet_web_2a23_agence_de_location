...
<div id="app">
                ...
                <ul class="sidebar-menu">
                   <!-- <li class="menu-header">Dashboard</li>
                    ...
                    <li class="dropdown active">
                        ...
                        <ul class="dropdown-menu">
                            <li class="active"><a class="nav-link" href="components-article.php">Ajouter Un Utulisateur</a></li>
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li><a class="nav-link" href="affichageuserback.php">Afficher Les Utulisateurs</a></li>
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li><a href="modifieruserback.php">Modifier Les Utulisateurs</a></li>
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                           ...
                           <!-- <li class="menu-sub-header">Charts</li> -->
                            <li><a class="nav-link" href="supprimeruserback.php">Supprimer Les Utulisateurs</a></li>
        ...
        <div class="main-content">
            <section class="section">
                ...
                <div class="section-body">
                    <h2 class="section-title">Les Utulisateurs</h2>
                    <p class="section-lead">l'ajout d'un Utulisateur.</p>
    ...
    include_once '../controlleur/ReservationC.php';
...
<html>
	<head></head>
	<body>
    <button><a href="affichagereservationback.php">Retour à la liste des réservations</a></button>
          <hr>
    ...
    return pattern1.test(a.key )
        ...
        <form action="" method="POST">
            <table border="1" align="center">
               <!-- <tr>
                    <td>
                        <label for="id_u">L'identifiant d'utulisateur:
                        </label>
                    </td>
                    <td><input type="text" name="id_u" id="id_u" maxlength="20"></td>
                </tr>-->
				<tr>
                    <td>
                        <label for="date_db"> date debut de réservation :
                        </label>
                    </td>
                    <td><input type="date" name="date_db" id="date_db" maxlength="20"></td>
                </tr>
                <tr>
                    <td>
                        <label for="date_df"> date fin de réservation :
                        </label>
                    </td>
                    <td><input type="date" name="date_df" id="date_df" maxlength="20"></td>
                </tr>
                <tr>
                    <td>
                        <label for="num_permis">Numéro du permis:
                        </label>
                    </td>
                    <td><input type="number" name="num_permis" id="num_permis" maxlength="20"></td>
                </tr>
