...
<div id="app">
    ...
    if (
        ...
        if (
            ...
            header('Location:affichagedisponibiliteback.php');
        }
        else
...
<head>
    ...
    <div class="foto">
        ...
        <button><a href="affichagedisponibiliteback.php">Retour à la liste des disponibilites exclusives</a></button>
        ...
        <form action="" method="POST">
            <table border="1" align="center">
                ...
                <tr>
                    ...
                    <td><input type="text" name="mois" id="mois" value="<?php echo $disponibilite['mois']; ?>" maxlength="20"></td>
                </tr>
                ...
                <tr>
                    ...
                    <td><input type="text" name="dated" id="dated" value="<?php echo $disponibilite['dated']; ?>" maxlength="20"></td>
                </tr>
                ...
                <tr>
                    ...
                    <td><input type="text" name="datef" id="datef" value="<?php echo $disponibilite['datef']; ?>" maxlength="20"></td>
                </tr>
