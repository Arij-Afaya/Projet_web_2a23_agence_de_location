...
<div class="page-wrapper">
                        ...
                        <nav class="main-menu navbar-expand-md navbar-light">
                            ...
                            <div class="collapse navbar-collapse clearfix" id="navbarSupportedContent">
                                <ul class="navigation clearfix">
                                    <li class="current dropdown"><a href="index-2.php">Accueil</a>
                                    ...
                                    <li class="dropdown"><a href="services-dark.html">Véhicules</a>
                                        <ul>
                                            ...
                                            <li><a href="searchfront.php">Disponibiltés</a></li>
                                        </ul>
                                    </li>
    ...
    <section class="shop-section">
    	<div class="auto-container">
            ...
            <video width="1300" height="250" controls>
  <source src="misis.mp4" type="video/mp4">
  <source src="misis.ogg" type="video/ogg">
...
<html>
	...
	<body>
     ...
     <!--<button><a href="searchvehicule.php">search</a></button>-->
...
<input type="submit" value= "trier_les_resultats" >
		...
		<table border="1" align="center">
			<tr>
				<!--<th>idv_____________________</th>-->
				<th>marque__________________</th>
				<th>modele_______________</th>
				<th>annee____________________</th>
				<th>prix__________________</th>
                <th>image_______________________________________</th>
                <!--<th>rating__________________</th>-->



                <!--<th>feragh____________________</th>-->

                <th>Disponibilite_______________</th>


				<!--<th>Modifier_____________________</th>-->
				<!--<th>Supprimer_____________________</th>-->
			...
			<!--<td><?php //echo $vehicule['idv']; ?></td>-->
                ...
                <td><img src=<?php echo $vehicule['image'];  ?> alt= <?php echo $vehicule['marque'];  ?> /></td>
                <!--<td><?php //echo $vehicule['rating']; ?></td>-->
                <!--<td>
