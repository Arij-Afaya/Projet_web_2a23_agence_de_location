            ...
            <section class="section">
                <div class="section-header">
                    ...
                    <div class="section-header-breadcrumb">
                        <div class="breadcrumb-item active"><a href="#">Suppression</a></div>
                        <div class="breadcrumb-item"><a href="#">Localuxe</a></div>
                        <div class="breadcrumb-item">supprimer des evenements</div>
                    </div>
                </div>

                <div class="section-body">
                    <h2 class="section-title">Les Evenements</h2>
                    <p class="section-lead">supprimer evenement ici.</p> 
                    <div class="row">
                        <div class="col-12 col-sm-6 col-md-6 col-lg-3">
                            <article class="article">
                                <div class="article-header">
                                    <div class="article-image" data-background="assets/img/news/333.jpg">
                                    </div>
...
<html>
	<head></head>
	<body>
	  <!--  <button><a href="projects-classic.php">Ajouter un evenement</a></button> -->
		<center><h1>Liste des evenements</h1></center>
        <center>	<li><a href="projects-classic-nourhene.php">La liste des evenements sur le site</a></li> </center>
		<table border="1" align="center">
			...
			<tr>
				...
				<td><?php echo $evenement['nom_e']; ?></td>
				<td><?php echo $evenement['date_d']; ?></td>
				<td><?php echo $evenement['date_f']; ?></td>
				<td><?php echo $evenement['nbre_p']; ?></td>
				<td><?php echo $evenement['prix_e']; ?></td>
				<td><?php echo $evenement['sponsors']; ?></td>
                <td><img src=<?php echo $evenement['imagee']   ?> alt= "" height="150" width="150" <?php echo $evenement['nom_e'];  ?> /></td>
				<!-- <td>
					  <form method="POST" action="gmaps-advanced-route.php">
						<input type="submit" name="Modifier" value="Modifier"> 
						<input type="hidden" value=<?PHP echo $evenement['id_e']; ?> name="id_e">
					</form>
				</td> -->
				<td>
				<a href="supprimerevenement.php?id_e=<?php echo $evenement['id_e']; ?>">Supprimer</a> 
				</td>
			</tr>
			<?php
				}
