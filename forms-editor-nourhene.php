...
<div id="app">
    ...
    if (isset($_GET['id_s'])){
        $listesponsors = $sponsorsC->recherchesponsors($_GET['id_s']); 
    }else {
                $listesponsors = $sponsorsC->affichers();
            }
?>
    ...
    <center> <form action="" method="GET" 
                        ...
                        <div class="input-group">
                         ...
                         <!--  name lazem aalkhtr najmooo nrecupiro byh l valeur -->
                            <input type="text" name="id_s" class="form-control bg-light border-0 small" placeholder="Search for..."
        ...
        <center>	<li><a href="projects-fullwidth-nourhene.php">La liste des sponsors sur le site</a></li> </center>
		<table border="1" align="center">
			...
			<tr>
				...
				<td>
					 <form method="POST" action="gmaps-draggable-marker-nourhene.php">
