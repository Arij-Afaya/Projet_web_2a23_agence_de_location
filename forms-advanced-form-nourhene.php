...
<div id="app">
    ...
    if (isset($_GET['id_e'])){
        $listeevenement = $evenementC->rechercheevenement($_GET['id_e']); 
    }else {
                $listeevenement = $evenementC->afficherevenement();
            }
    ...
    <center> <form action="" method="GET" 
                        ...
                        <div class="input-group">
                         ...
                         <!--  name lazem aalkhtr najmooo nrecupiro byh l valeur -->
                            <input type="text" name="id_e" class="form-control bg-light border-0 small" placeholder="Search for..."
	   ...
	   <button><a href="searchevenement.php"> search nourhene</a></button> 
		...
		<table border="1" align="center">
			...
			<tr>
				...
				<td>
					  <form method="POST" action="gmaps-advanced-route-nourhene.php">
