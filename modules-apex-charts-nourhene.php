            ...
            <section class="section">
                <div class="section-header">
                    ...
                    <div class="section-header-breadcrumb">
                        ...
                        <div class="breadcrumb-item">Supprimer les Sponsors</div>
                    </div>
                </div>

                <div class="section-body">
                    <h2 class="section-title">Les Sponsors</h2>
                    <p class="section-lead">supprimer sponsors ici.</p> 
                    <div class="row">
                        <div class="col-12 col-sm-6 col-md-6 col-lg-3">
                            <article class="article">
                                <div class="article-header">
                                    <div class="article-image" data-background="assets/img/news/v3.PNG">
                                    </div>
...
<html>
	...
	<body>
        ...
        <center>	<li><a href="projects-fullwidth-nourhene.php">La liste des evenements sur le site</a></li> </center>
		<table border="1" align="center">
			...
			<tr>
                ...
                <td><img src=<?php echo $sponsors['imagee1']   ?> alt= "" height="150" width="150" <?php echo $sponsors['nom_s'];  ?> /></td>
			
				<!-- <td>
					 <form method="POST" action="gmaps-draggable-marker.php">
						<input type="submit" name="Modifier" value="Modifier"> 
						<input type="hidden" value=<?PHP echo $sponsors['id_s']; ?> name="id_s">
					</form>
				</td> -->
				<td>
					<a href="deletes.php?id_s=<?php echo $sponsors['id_s']; ?>">Supprimer</a> 
				</td>
			</tr>
			<?php
				}
