...
<title>Gestion des véhicules &rsaquo;  &mdash; Localuxe</title>
        ...
        <div class="main-sidebar sidebar-style-2">
            <aside id="sidebar-wrapper">
                <div class="sidebar-brand">
                    <a href="index-2.html">Gestion Des véhicules</a>
                </div>
                ...
                <ul class="sidebar-menu">
                   <!-- <li class="menu-header">Dashboard</li>
                    ...
                    <li class="dropdown active">
                        ...
                        <ul class="dropdown-menu">
                            <li class="active"><a class="nav-link" href="components-article.php">Ajouter Un véhicule</a></li>
                            <li class="active"><a class="nav-link" href="components-avatar.php">Ajouter Une disponibilité exclusive</a></li>
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li><a class="nav-link" href="forms-advanced-form.php">Afficher Les véhicules</a></li>
                            <li><a class="nav-link" href="affichagedisponibiliteback.php">Afficher Les disponibilités</a></li>
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li><a href="gmaps-advanced-route.php">Modifier Les véhicules</a></li>
                            <li><a href="gmaps-draggable-marker.php">Modifier Les disponibilités</a></li>
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                           ...
                           <!-- <li class="menu-sub-header">Charts</li> -->
                            <li><a class="nav-link" href="modules-chartjs.php">Supprimer Les Sponsors</a></li>
                            <li><a class="nav-link" href="modules-apex-charts.php">Supprimer Les Sponsors</a></li>
            ...
            <section class="section">
                <div class="section-header">
                    ...
                    <div class="breadcrumb-item active"><a href="#">GESTION DES UTILISATEURS</a></div>
                        ...
                        <div class="breadcrumb-item"><a href="forms-advanced-form-nourhene.php">GESTION DES EVENEMENTS</a></div>
   ...
   // isset($_POST["idv"]) &&
    ...
    if (
       //!empty($_POST["idv"]) && 
        ...
        $vehiculeC->ajouteradherent($vehicule);
...
<script type="text/javascript" src="scriptv.js"></script>
...
<body>
    ...
    <button><a href="forms-advanced-form.php">Retour à la liste des vehicules</a></button>
    ...
    <form action="" method="POST">
        ...
        <table border="1" align="center">
            ...
            <!--<tr>
                ...
                <td><input type="number" name="idv" id="idv" maxlength="20"></td>
            </tr>-->
            <tr>
                <td>
                ...
                <td><input type="text" name="marque" id="marque" maxlength="20" onkeypress="return validateChar(event)"></td>
            </tr>
            ...
            <tr>
                ...
                <td><input type="text" name="modele" id="modele" maxlength="20" onkeypress="return validateChar(event)"></td>
            </tr>
            ...
            <tr>
                ...
                <td><input type="number" name="annee" id="annee" maxlength="20" min=1999 max=2022></td>
            </tr>
            ...
            <tr>
                ...
                <td><input type="text" name="prix" id="prix" maxlength="20" onkeypress="return validateNumber(event)"></td>
            </tr>
            ...
            <tr>
                ...
                <td><input type="text" name="image" id="image" onchange="return fileValidation()"></td>
            </tr>
            ...
            <tr>
                ...
                <td><input type="text" name="disponibilite" id="disponibilite" ></td>
            </tr>
