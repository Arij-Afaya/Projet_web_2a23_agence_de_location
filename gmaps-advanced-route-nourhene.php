...
<title>Gestion des evenements &rsaquo;  &mdash; Localuxe</title> 
        ...
        <nav class="navbar navbar-expand-lg main-navbar">
            ...
            <ul class="navbar-nav navbar-right">
                    ...
                    <div class="dropdown-list-content dropdown-list-message">
                        <a href="#" class="dropdown-item dropdown-item-unread">
                            <div class="dropdown-item-avatar">
                                <img alt="image" src="assets/img/avatar/q1.jpg" class="rounded-circle">
                ...
                <li class="dropdown">
                    ...
                    <img alt="image" src="assets/img/avatar/q1.jpg" class="rounded-circle mr-1">
                    <div class="d-sm-none d-lg-inline-block">Salut, Nourhene Chammakhi </div></a>
        ...
        <div class="main-sidebar sidebar-style-2">
            <aside id="sidebar-wrapper">
                <div class="sidebar-brand">
                    <a href="index-2.html">Gestion Des Evenements</a>
                </div>
                ...
                <ul class="sidebar-menu">
                   <!-- <li class="menu-header">Dashboard</li>
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li class="active"><a class="nav-link" href="components-article-nourhene.php">Ajouter Un Evenement</a></li>
                            <li class="active"><a class="nav-link" href="components-avatar-nourhene.php">Ajouter Un Sponors</a></li>
                    ...
                    <li class="dropdown ">
                        ...
                        <ul class="dropdown-menu">
                            <li><a class="nav-link" href="forms-advanced-form-nourhene.php">Afficher Les Evenements</a></li>
                            <li><a class="nav-link" href="forms-editor-nourhene.php">Afficher Les Sponsors</a></li>
                    ...
                    <li class="dropdown active">
                        ...
                        <ul class="dropdown-menu">
                            <li><a href="gmaps-advanced-route-nourhene.php">Modifier Les Evenements</a></li>
                            <li><a href="gmaps-draggable-marker-nourhene.php">Modifier Les Sponsors</a></li>
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                           ...
                           <!-- <li class="menu-sub-header">Charts</li> -->
                            <li><a class="nav-link" href="modules-chartjs-nourhene.php">Supprimer Les Sponsors</a></li>
                            <li><a class="nav-link" href="modules-apex-charts-nourhene.php">Supprimer Les Sponsors</a></li>
            ...
            <section class="section">
                <div class="section-header">
                    ...
                    <div class="section-header-breadcrumb">
                        <div class="breadcrumb-item active"><a href="#">Modification</a></div>
                        <div class="breadcrumb-item"><a href="#">Localuxe</a></div>
                        <div class="breadcrumb-item">Modifier les Evenements</div>
                    </div>
                </div>

                <div class="section-body">
                    <h2 class="section-title">Les Evenements</h2>
                    <p class="section-lead">Modifier ici les evenements.</p> 
                    <div class="row">
                        <div class="col-12 col-sm-6 col-md-6 col-lg-3">
                            <article class="article">
                                <div class="article-header">
                                    <div class="article-image" data-background="assets/img/news/111.jpg">
                                    </div>
...
<?php
    ...
    include_once '../controlleur/evenementC.php';
    ...
    if (
        ...
        if (
            ...
            $evenementC->modifierevenement($evenement, $_POST["id_e"]);
            header('Location:afficherListeevenement.php');
        }
        else
...
<head>
    ...
    <body>
        <button><a href="afficherListeevenement.php">Retour à la liste des evenements</a></button>
        <hr>
		...
		<?php
			if (isset($_POST['id_e'])){
				$evenement = $evenementC->recupererevenement($_POST['id_e']);
        ...
        <form action="" method="POST">
            <table border="1" align="center">
                <tr>
                    <td>
                        <label for="id_e">l'id du l'evenement:
                        </label>
                    </td>
                    <td><input type="text" name="id_e" id="id_e" value="<?php echo $evenement['id_e']; ?>" maxlength="20"></td>
                </tr>
				<tr>
                    <td>
                        <label for="nom_e">Nom du l'evenement:
                        </label>
                    </td>
                    <td><input type="text" name="nom_e" id="nom_e" value="<?php echo $evenement['nom_e']; ?>" maxlength="20"></td>
                </tr>
                <tr>
                    <td>
                        <label for="date_d">date debut de l'evenement:
                        </label>
                    </td>
                    <td><input type="date" name="date_d" id="date_d" value="<?php echo $evenement['date_d']; ?>" maxlength="20"></td>
                </tr>
                <tr>
                    <td>
                        <label for="date_f">date final de l'evenement:
                        </label>
                    </td>
                    <td><input type="date" name="date_f" id="date_f" value="<?php echo $evenement['date_f']; ?>" maxlength="20"></td>
                </tr>
                <tr>
                    <td>
                        <label for="nbre_p">nombre du personne participants:
                        </label>
                    </td>
                    <td>
                        <input type="number" name="nbre_p" value="<?php echo $evenement['nbre_p']; ?>" id="nbre_p">
                    </td>
                </tr>
                <tr>
                    <td>
                        <label for="prix_e">prix:
                        </label>
                    </td>
                    <td>
                        <input type="number" name="prix_e" id="prix_e" value="<?php echo $evenement['prix_e']; ?>">
                    </td>
                </tr>
                <tr>
                    <td>
                        <label for="liste_s">liste des sponsors:
                        </label>
                    </td>
                    <td>
                        <input type="text" name="liste_s" id="liste_s" value="<?php echo $evenement['sponsors']; ?>">
                    </td>
                </tr>            
                <tr>
                    <td>
                        <label for="imagee">l'image:
                        </label>
                    </td>
                    <td>
                        <input type="text" name="imagee" id="imagee" value="<?php echo $evenement['imagee']; ?>">
                    </td>
                </tr>             
                <tr>
                    <td></td>
