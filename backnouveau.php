        ...
        <div class="main-sidebar sidebar-style-2">
            <aside id="sidebar-wrapper">
                ...
                <ul class="sidebar-menu">
                    ...
                    <br>
                    <li class="dropdown">
                    <li><a href="components-article-nourhene.php"><i> <strong>GESTION DES EVENEMENTS</strong>></i></a></li>
            ...
            <section class="section">
                <div class="section-header">
                    ...
                    <div class="section-header-breadcrumb">
                        <div class="breadcrumb-item active"><a href="index-2.php">Localuxe</a></div>
