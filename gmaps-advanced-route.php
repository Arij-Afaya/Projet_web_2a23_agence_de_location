...
<!-- gmaps-advanced-route.html  Tue, 07 Jan 2020 03:38:00 GMT -->
<head>
<meta charset="UTF-8">
<meta content="width=device-width, initial-scale=1, maximum-scale=1, shrink-to-fit=no" name="viewport">
<title>Google Maps &rsaquo; Advanced Route &mdash; CodiePie</title>
            ...
            <aside id="sidebar-wrapper">
                ...
                <ul class="sidebar-menu">
                    ...
                    <li class="dropdown active">
                        ...
                        <ul class="dropdown-menu">
                            <li class="active"><a href="gmaps-advanced-route.html">supprimer</a></li>
        ...
        <div class="main-content">
            <section class="section">
                ...
                <div class="section-body">
                    ...
                    <p class="section-lead">The same as the 'route' example, but in this example it will be a bit cooler. Click the 'Start Travel' button to start seeing magic.</p>
...
<script src="js/page/gmaps-advanced-route.js"></script>
...
<!-- gmaps-advanced-route.html  Tue, 07 Jan 2020 03:38:04 GMT -->
</html>