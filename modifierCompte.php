...
<body class="u-body"><header class="u-clearfix u-header u-header" id="sec-93f3"><div class="u-clearfix u-sheet u-sheet-1">
...
</li><li class="u-nav-item"><a class="u-border-active-palette-1-base u-border-hover-palette-1-base u-border-no-left u-border-no-right u-border-no-top u-button-style u-nav-link u-text-active-palette-1-base u-text-grey-90 u-text-hover-palette-2-base" href="compte.html" style="padding: 10px 28px;">compte</a>
</li><li class="u-nav-item"><a class="u-border-active-palette-1-base u-border-hover-palette-1-base u-border-no-left u-border-no-right u-border-no-top u-button-style u-nav-link u-text-active-palette-1-base u-text-grey-90 u-text-hover-palette-2-base" href="Contact.html" style="padding: 10px 31px 10px 28px;">Contact</a>
</li></ul>
          </div>
...
</li><li class="u-nav-item"><a class="u-button-style u-nav-link" href="compte.html" style="padding: 10px 20px;">compte</a>
	...
	s80-35.8,80-80S124.2,0,80,0L80,0z"></path></svg>
        ...
        <div class="u-align-left u-container-style u-expanded-width-xs u-group u-radius-12 u-shape-round u-white u-group-1">
          <div class="u-container-layout u-container-layout-1"><span class="u-icon u-icon-1"><svg class="u-svg-link" preserveAspectRatio="xMidYMin slice" viewBox="0 0 53 53" style=""><use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#svg-4070"></use></svg><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" xml:space="preserve" class="u-svg-content" viewBox="0 0 53 53" x="0px" y="0px" id="svg-4070" style="enable-background:new 0 0 53 53;"><path style="fill:#E7ECED;" d="M18.613,41.552l-7.907,4.313c-0.464,0.253-0.881,0.564-1.269,0.903C14.047,50.655,19.998,53,26.5,53
	...
	C20.296,39.899,19.65,40.986,18.613,41.552z"></path><g><path style="fill:#556080;" d="M26.953,0.004C12.32-0.246,0.254,11.414,0.004,26.047C-0.138,34.344,3.56,41.801,9.448,46.76
		...
		c0.508,0.254,0.967,0.575,1.39,0.932c5.71-4.762,9.399-11.882,9.536-19.9C53.246,12.32,41.587,0.254,26.953,0.004z"></path>
            ...
            <h2 class="u-custom-font u-font-lobster u-text u-text-palette-1-base u-text-1">modifier le compte</h2>
        ...
        <div class="u-form-group u-form-name">
                        <label for="id" class="u-custom-font u-font-lobster u-label u-label-1">cin:</label>
                    <input type="text" name="id" id="id" value="<?php echo $user['id']; ?>" class="u-input u-input-rectangle u-palette-5-light-2 u-radius-12" required="" maxlength="20">
                    </div> 

                    <div class="u-form-group u-form-name">
                        <label for="username" class="u-custom-font u-font-lobster u-label u-label-1">username:</label>
                    <input type="text" name="username" id="username" value="<?php echo $user['username']; ?>"  class="u-input u-input-rectangle u-palette-5-light-2 u-radius-12" required="" maxlength="20">
                    </div>


                    <div class="u-form-email u-form-group">
                        <label for="email"  class="u-custom-font u-font-lobster u-label u-label-2">email:</label>
                        <input type="email" name="email" id="email" value="<?php echo $user['email']; ?>"  class="u-input u-input-rectangle u-palette-5-light-2 u-radius-12" required="" maxlength="60">
                  </div>

                  <div class="u-form-group u-form-group-3">

                        <label for="pwd" class="u-custom-font u-font-lobster u-label u-label-3">pwd:</label>
                        <input type="password" name="pwd" id="pwd " value="<?php echo $user['pwd']; ?>" class="u-input u-input-rectangle u-palette-5-light-2 u-radius-12">
                    </div>
                    ...
                    <div class="u-form-group u-form-group-4">
                        ...
                        <label for="confirmer" class="u-custom-font u-font-lobster u-label u-label-4">confirmer pwd:
                        </label>
                    
                        <input type="password" name="confirmer" id="confirmer" value="<?php echo $user['confirmer']; ?>" class="u-input u-input-rectangle u-palette-5-light-2 u-radius-12">
                        </div>
                        ...
                        <input type="date" name="datee" id="datee" value="<?php echo $user['datee']; ?>" class="u-input u-input-rectangle u-palette-5-light-2 u-radius-12">
                        </div>
                        <div class="u-form-group u-form-group-3">
                        <label for="typee"  class="u-custom-font u-font-lobster u-label u-label-4">type:
                        </label>
                   
                        <input type="text" name="typee" id="typee" value="<?php echo $user['typee']; ?>" class="u-input u-input-rectangle u-palette-5-light-2 u-radius-12">
                        </div>
