            ...
            <aside id="sidebar-wrapper">
                ...
                <ul class="sidebar-menu">
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li><a class="nav-link" href="ajouterreponse.php">ajout reponse</a></li>
                        </ul>
                    </li>
                    <li class="dropdown active">
                        <a href="#" class="nav-link has-dropdown"><i class="far fa-file-alt"></i> <span>Affichage</span></a>
                        <ul class="dropdown-menu">
                            <li class="active"><a class="nav-link" href="afficherListereclamations.php">affichage réclamations</a></li>
                            <li><a class="nav-link" href="afficherListereponses.php">affichage réponses</a></li>
                        </ul>
                    </li>
                    <li class="dropdown">
...
<head>
    ...
    <body>
        <center><button><a href="afficherListereponses.php">Retour à la liste des reponses</a></button></center>
        <hr>
...
<div style="background-image:url('aaa.png');padding:5px;width:1500;height:4000px;border:1px solid black;">
</br>
           <center> <table border="2" ></center>
                
				<tr>
                    <td>
                        <label for="date_r">Date:
                        </label>
                    </td>
                    <td><input type="date" name="date_r" id="date_r"></td>
                </tr>
                <tr>
                    <td>
                    ...
                    <td><input type="text" name="reponse_r" id="reponse_r" maxlength="100"></td>
                </tr>
