            ...
            <aside id="sidebar-wrapper">
                ...
                <ul class="sidebar-menu">
                    ...
                    <li class="dropdown active">
                        ...
                        <ul class="dropdown-menu">
                            <li class="active"><a class="nav-link" href="back-reclamation.php">affichage réclamations</a></li>
            ...
            <section class="section">
                ...
                <h1>Réclamations</h1>
                    <div class="section-header-breadcrumb">
                        ...
                        <div class="breadcrumb-item"><a href="forms-advanced-form-nourhene">GESTION DES EVENEMENTS</a></div>
...
<html>
	...
	<body>
		...
		<table border="1" align="center">
			...
			?>
			<tr>
				<td><?php echo $reponse['id_r']; ?></td>
				<td><?php echo $reponse['date_r']; ?></td>
				<td><?php echo $reponse['reponse_r']; ?></td>
				

				<td>
					<form method="POST" action="modifierreponse.php">
						<input type="submit" name="Modifier" value="Modifier">
						<input type="hidden" value=<?PHP echo $reponse['id_r']; ?> name="id_r">
					</form>
				</td>
				<td>
					<a href="supprimerreponse.php?id_r=<?php echo $reponse['id_r']; ?>">Supprimer</a>
				</td>
			</tr>
			<?php
				}
