        ...
        <body>
            ...
            <form action="" method="POST">
                ...
                <!--  <tr>
                    ...
                    <tr> -->
                        <td>
                            <label for="nom_e">le nom du l'evenement:
                            </label>
                        </td>
                        <td><input type="text" name="nom_e" id="nom_e" maxlength="20"></td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td><input type="date" name="date_d" id="date_d" maxlength="20"></td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td><input type="date" name="date_f" id="date_f" maxlength="20"></td>
                    </tr>
                    <tr>
                        <td>
                            <label for="nbre_p">Nombre de personnes participants:
                            </label>
                        </td>
                        <td>
                            <input type="number" name="nbre_p" id="nbre_p">
                        </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td>
                            <input type="number" name="prix_e" id="prix_e">
                        </td>
                    </tr>
                    <tr>
                        <td>
                            <label for="liste_s">liste de sponsors:
                            </label>
                        </td>
                        <td>
                            <input type="text" name="liste_s" id="liste_s" >
                        </td>
                    </tr>       
                    <tr>
                        <td>
