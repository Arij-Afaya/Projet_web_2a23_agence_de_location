        ...
        <div class="main-content">
            <section class="section">
                ...
                <div class="section-body">
                    ...
                    <img src="assets/img/avatar/vv1.png" alt="...">
      ...
      //  isset($_POST["id_s"]) &&
        ...
        if (
           // !empty($_POST["id_s"]) && 
            ...
            $sponsorsC->ajouters($sponsors);
            header('Location:afficherListessponsors.php');
        }
        else
...
<head>
    ...
    <body>
        <button><a href="afficherListessponsors.php">Retour à la liste des sponsors</a></button>
        <hr>
        ...
        <form action="" method="POST">
            ...
            <!--  <tr>
                    ...
                    <td><input type="text" name="id_e" id="id_e" maxlength="20"></td>
                </tr>
				<tr> -->
                    <td>
                        <label for="nom_s">le nom du sponsors:
                        </label>
                    </td>
                    <td><input type="text" name="nom_s" id="nom_s" maxlength="20"></td>
                </tr>
                <tr>
                    <td>
                        <label for="date_contrat">date du contrat:
                        </label>
                    </td>
                    <td><input type="date" name="date_contrat" id="date_contrat" maxlength="20"></td>
                </tr>
                ...
                <tr>
                    ...
                    <td>
                        <input type="number" name="prix_contrat" id="prix_contrat">
                    </td>
                </tr>
                <tr>
                    <td>
                    ...
                    <td>
                        <input type="text" name="imagee1" id="imagee1">
                    </td>
                </tr>
                <tr>
                    <td></td>
