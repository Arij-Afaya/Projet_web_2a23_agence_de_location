...
<form action="" method="POST">
            <table border="1" align="center">
                <tr>
                    <td>
                        <label for="idcategorie">idcategori :
                        </label>
                    </td>
                    <td><input type="number" name="idcategorie" id="idcategorie" maxlength="20"></td>
                </tr>
				<tr>
                    <td>
...
<OPTION>Web Development
                ...
                <tr>
                    ...
                    <td><input type="text" name="nbrearticle" id="nbrearticle" maxlength="20"></td>
                </tr>   
                <tr>
                    <td>
